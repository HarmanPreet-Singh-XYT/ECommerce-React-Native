...
import paymentGatewayHandler from "../../api/paymentSystem";
import { useNavigation } from "@react-navigation/native";
import { NativeStackNavigationProp } from 'react-native-screens/lib/typescript/native-stack/types';
export default function CheckoutScreen({customerName,email,contactNumber,userID,productID,createOrder}:{productID:number,customerName:string,email:string,contactNumber:number,clientSecret:string,userID:number,createOrder:()=>void}) {
