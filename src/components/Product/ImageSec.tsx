...
const ImageSec = ({data,mainImage,setSelectedImage}:{data:ProductImage[],mainImage:MainImage,setSelectedImage:React.Dispatch<SetStateAction<{imgLink:string,imgAlt:string}>>}) => {
  return (
    <View className='w-[90%] mx-auto'>
        <View className='w-[100%] items-center justify-center border-[1px] border-customsalmon rounded-2xl py-4 mb-4'>
        <Image source={{uri:mainImage.imglink}} alt={mainImage.imgalt}  className='w-[95%] h-[300px] mx-auto bg-black' />
        </View>
